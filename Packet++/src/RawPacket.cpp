...
void RawPacket::insertData(int atIndex, const uint8_t *dataToInsert, size_t dataToInsertLen)
{
	...
	// overlapping src/dest ptrs if insertData is called with atIndex == m_RawDataLen, then no data is being moved. The
	// data of the raw packet is still extended by dataToInsertLen
